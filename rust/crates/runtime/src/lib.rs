...
pub use prompt::{
    ...
    resolve_model_family_for_prompt, ContextFile, ProjectContext, PromptBuildError,
    SystemPromptBuilder, AUTO_HIDDEN_SYSTEM_PROMPT_KEY, DEFAULT_MAX_INSTRUCTION_FILE_CHARS,
    DEFAULT_MAX_TOTAL_INSTRUCTION_CHARS, FRONTIER_MODEL_NAME, GATEWAY_DATA_CATALOG_REL,
    GATEWAY_POOL_DS_CONFIG_ROOT, GATEWAY_SCHEMA_MD_REL,
