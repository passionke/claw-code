...
pub use prompt::{
    ...
    GATEWAY_DATA_CATALOG_REL, GATEWAY_SCHEMA_MD_REL, GATEWAY_SQLBOT_MCP_DATASOURCE_EXAMPLES_TOOL,
    GATEWAY_SQLBOT_MCP_DATASOURCE_LIST_TOOL, GATEWAY_SQLBOT_MCP_DATASOURCE_TABLES_TOOL,
    GATEWAY_SQLBOT_MCP_DATASOURCE_TERMINOLOGIES_TOOL, GATEWAY_SQLBOT_MCP_START_TOOL,
    GATEWAY_SQL_EXAMPLES_MD_REL, GATEWAY_SYSTEM_PROMPT_SCAFFOLD_REL,
