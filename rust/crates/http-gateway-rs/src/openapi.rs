...
#[openapi(
    ...
    paths(
        crate::routes::admin_auth::login_handler,
        crate::routes::admin_auth::logout_handler,
        crate::routes::admin_auth::me_handler,
        crate::routes::admin_auth::list_accounts_handler,
        crate::routes::admin_auth::create_account_handler,
        crate::routes::admin_auth::patch_account_handler,
        crate::routes::admin_auth::put_member_handler,
        crate::routes::admin_auth::delete_member_handler,
        crate::routes::admin_auth::list_my_mcp_tokens_handler,
        crate::routes::admin_auth::issue_my_mcp_token_handler,
        crate::routes::admin_auth::revoke_my_mcp_token_handler,
        crate::routes::admin_auth::list_my_sessions_handler,
        crate::routes::admin_auth::issue_my_session_handler,
        crate::routes::admin_auth::revoke_my_session_handler,
        ...
        crate::routes::app::get_gateway_bootstrap_env_snapshot_handler,
        crate::routes::app::get_gateway_bootstrap_publish_templates_handler,
        crate::routes::app::get_gateway_bootstrap_ci_image_tags_handler,
        crate::routes::app::post_gateway_bootstrap_apply_deploy_env_handler,
        ...
        crate::routes::app::post_gateway_bootstrap_complete_handler,
        crate::routes::app::post_gateway_bootstrap_reopen_handler,
        crate::routes::app::post_gateway_bootstrap_reset_handler,
        crate::routes::app::post_gateway_bootstrap_publish_templates_handler,
        ...
        crate::routes::app::lookup_gateway_llm_context_window_handler,
        crate::routes::app::verify_gateway_llm_context_window_handler,
        ...
        crate::routes::app::upload_project_skill_archive,
        crate::routes::app::get_project_skill_tree,
        crate::routes::app::put_project_skill_files,
        crate::routes::app::download_project_skill_archive,
        ...
        crate::routes::app::lookup_project_llm_context_window_handler,
        crate::routes::app::verify_project_llm_context_window_handler,
        ...
        crate::routes::app::list_session_plans,
        crate::routes::app::get_session_plan,
        crate::routes::app::confirm_session_plan,
        crate::routes::app::post_ask_user_answer,
    ...
    components(schemas(
        ...
        crate::gateway_bootstrap_publish::BootstrapCiImageTagsResponse,
        crate::gateway_bootstrap_deploy::BootstrapEnvSnapshot,
        crate::gateway_bootstrap_deploy::BootstrapEnvValidation,
        crate::gateway_bootstrap_deploy::BootstrapApplyDeployEnvInput,
        crate::gateway_bootstrap_deploy::BootstrapApplyDeployEnvResponse,
        crate::gateway_e2b_singleton_api::E2bSingletonsStatusResponse,
        crate::claw_tap_cluster_state::ClawTapClusterSnapshot,
        crate::claw_tap_cluster_state::TapConsistency,
        ...
        crate::routes::admin_auth::LoginBody,
        crate::routes::admin_auth::LoginResponse,
        crate::routes::admin_auth::MeResponse,
        crate::routes::admin_auth::AdminSessionPublic,
        crate::routes::admin_auth::ListSessionsResponse,
        crate::routes::admin_auth::IssueSessionResponse,
        crate::routes::admin_auth::CreateAccountBody,
        crate::routes::admin_auth::PatchAccountBody,
        crate::admin_auth::AccountPublic,
    ...
    tags(
        ...
        (name = "Admin Auth", description = "Human admin accounts, membership, and personal MCP tokens"),
