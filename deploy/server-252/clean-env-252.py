...
KEEP_KEYS = frozenset(
    {
        ...
        "CLAW_E2B_DOMAIN",
        "CLAW_E2B_TEMPLATE",
        "CLAW_E2B_NAS_API_TEMPLATE",
        "CLAW_E2B_OVS_TEMPLATE",
        "CLAW_E2B_OBSERVE_TEMPLATE",
        "CLAW_E2B_NAS_HOST_MOUNT",
        "CLAW_E2B_SANDBOX_TIMEOUT_SECS",
        "CLAW_E2B_PROJECT_WORKER_TTL_SECS",
        "CLAW_E2B_PROJECT_WORKER_RENEW_INTERVAL_SECS",
        "CLAW_AUTO_BOOTSTRAP",
        "CLAW_BOOTSTRAP_LLM_API_KEY",
        "CLAW_BOOTSTRAP_LLM_BASE_URL",
        "CLAW_BOOTSTRAP_LLM_MODEL_NAME",
        "PLAYGROUND_PUBLIC_GATEWAY_BASE",
        "CLAW_GATEWAY_PUBLIC_HOST",
...
def main() -> None:
    ...
    defaults: dict[str, str] = {
        ...
        "CLAW_LLM_PROXY": "direct",
        "GATEWAY_HOST_PORT": kept.get("GATEWAY_HOST_PORT", "18088"),
        "GATEWAY_PLAYGROUND_HOST_PORT": kept.get("GATEWAY_PLAYGROUND_HOST_PORT", "18765"),
    ...
    header = """# 192.168.9.252 — human .env (Rust http-gateway-rs + e2b; no host pool)
# Author: kejiqing
# One-click: ./deploy/stack/gateway.sh 252-up --release release-vX.Y.Z
# Template: deploy/server-252/env.pre-252.e2b.example
# Do NOT set GATEWAY_IMAGE=:local here. LLM: prefer Admin → PG; bootstrap keys optional.
