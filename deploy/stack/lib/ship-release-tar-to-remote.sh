...
#
# Usage:
#   ./deploy/stack/lib/ship-release-tar-to-remote.sh release-v1.0.25
#   ./deploy/stack/lib/ship-release-tar-to-remote.sh release-v1.0.25 admin@192.168.9.252
#
# Env:
...
echo "  cd ~/claw-code && CLAW_IMAGE_PREFIX=${PREFIX} ./deploy/stack/gateway.sh up --release ${TAG}"
echo ""
