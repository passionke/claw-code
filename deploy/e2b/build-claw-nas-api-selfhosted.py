...
Bakes deploy/e2b/claw-nas-api/server.py into /opt/claw-nas-api. The gateway
launches it after sandbox create (see e2b_nas_api_singleton), same pattern as observe.
"""
