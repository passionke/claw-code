...
from e2b_template_registry import load_repo_dotenv, log_debian_base_resolution, template_debian_base_image, template_apt_prepare_prefix
...
def main() -> int:
    ...
    try:
        ...
        print(
            f"==> persisted e2bOvs.templateId={build.template_id!r} "
